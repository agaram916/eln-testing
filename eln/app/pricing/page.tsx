...
function Plan () {
    ...
    const [activeTabinner, setActiveTabinner] = useState('standard-tab');
    ...
    const handleHashChange = () => {
      ...
      if (hash) {
        setActiveTabinner(hash); // Update active tab based on hash
      }
    };
      ...
      <center>
          ...
          <div className="pricing-table-area section-space--ptb_100 bg-gray1">
                <div className="container">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="section-title-wrapper text-center mb-20 wow move-up animated" >
                                                ...
                                                {/* <input type="number" min="1" max="200" value={qty.toString()} className="qty" id="qty" onChange={handleQtyChange} style={{ marginBottom: "20px" }} /><br/>
                                                {errorMsg && (<span id="errorMsg" style={{color:"red", display:"block"}}>*For teams larger than 200, check out our Enterprise  plan</span>)} */}
                    ...
                    <div className="row">
                        ...
                        <div className={`responsive-tabs ${isOpen ? 'open' : ''}`} onClick={handleTabClick}>
                          ...
                          <li className="tab__item nav-item">
                              <Link 
                                  className="nav-link active standard-tab" 
                                  id="nav-tab1" 
                                  href="#standard-tab" 
                                  role="tab" 
                                  aria-selected="true"
                          ...
                          <li className="tab__item nav-item">
                              <Link className="nav-link academichover" href="/pricing/academic_plans" target="_blank">
                                  Academic
                              </Link>
                          </li>
                        </ul>
                    ...
                    {activeTabinner === 'standard-tab' && <div className={`tab-pane ${activeTabinner === 'standard-tab' ? "active show" : ""} `} id="standard-tab" role="tabpanel">
                                  ...
                                  <div className="container">
                                    <div className="row pricing-table-one">
                                      ...
                                      <div className="col-12 col-md-6 col-lg-3 col-xl-3 pricing-table" style={{ visibility: "visible" }}>
                                        <div className="pricing-table__inner free-bg">
                                          <div className="pricing-table__header" style={{paddingTop:"18px"}}>
                                            {/* <h6 className="sub-title" style={{marginBottom:"0 !important"}}>ELN Lite 1</h6>
                                            ...
                                            <div className="pricing-table__feature-mark"><span className='text-white fw-bold'>Popular</span></div>

                                              <Image src={loglab_Eln} className="img-fluid mb-2 position-relative" alt="" style={{width:'150px'}}/> 
                                              <p  style={{color:'#000000', fontSize:'14px'}}  className='sub-para mt-2 '> <b>For getting familiar with ELN </b></p>
                                          </div>
                                          <div className="pricing-table__body">
                                            ...
                                            <div className="align-left mt-30">
                                              <b style={{color:'#000000'}}>Everything you need, at no cost</b>
                                              <ul className="dark-check-list">
                                                <li className="list-item">Simple & User-friendly Interface</li>
                                                <li className="list-item">Invite up to 3 users</li>
                                                <li className="list-item">SSO (Google and Microsoft)</li>
                                                <li className="list-item">Intuitive Experiment Templates
                                                </li>
                                                <li className="list-item">Basic Inventory 
                                                </li>
                                              </ul>
                                            </div>
                                          </div>
                                      ...
                                      {/* Standard Plan */}
                                      <div className="col-12 col-md-6 col-lg-3 col-xl-3 pricing-table" style={{ visibility: "visible" }}>
                                        <div className="pricing-table__inner perpul-bg">
                                          {/* <div className="badge badge-standard">Recommended</div> */}
                                          <div className="pricing-table__header">
                                            <h6 className="sub-title">Standard</h6>
                                            <b className="sub-para" style={{color:'#000000'}}>For individuals and small teams
                                            </b><br />
                                            {/* <span className="price" style={{color:'#000000'}}>$<span id="singleuser_standard">{singleUnitPrices.standard}</span></span><br />
                                            <span style={{color:'#000000'}}>per user / month</span><br /> */}
                                          </div>
                                          <div className="pricing-table__body">
                                            <div className="pricing-table__footer">
                                            ...
                                            <div className="align-left mt-30">
                                              <b style={{color:"#000000"}}>Everything in Free, plus</b>
                                              <ul className="dark-check-list">
                                      ...
                                      <div className="col-12 col-md-6 col-lg-3 col-xl-3 pricing-table pricing-table--popular" style={{ visibility: "visible" }}>
                                        <div className="pricing-table__inner green-bg">
                                                  <div className="badge badge-standard text-black fw-bold">Recommended</div>
                                          <div className="pricing-table__header">
                                            <h6 className="sub-title">Premium</h6>
                                            <b className="sub-para" style={{color:'#000000'}}>For mid-sized and large teams</b><br />
                                            {/* <span className="price" style={{color:'#000000'}}>$<span id="singleuser_premium">{singleUnitPrices.premium}</span></span><br />
                                            <span style={{color:'#000000'}}>per user / month</span><br /> */}
                                          </div>
                                          <div className="pricing-table__body">
                                            <div className="pricing-table__footer">
                                            ...
                                            <div className="align-left mt-30">
                                              <b style={{color:"#000000"}}>Everything in Standard, plus</b>
                                              <ul className="dark-check-list">
                                      ...
                                      {/* Enterprise Plan */}
                                      <div className="col-12 col-md-6 col-lg-3 col-xl-3 pricing-table" style={{ visibility: "visible" }}>
                                        <div className="pricing-table__inner blue-bg">
                                          {/* <div style={{ marginBottom: "40px" }}></div> */}
                                          <div className="pricing-table__header">
                                            <h6 className="sub-title">Enterprise</h6>
                                            <b className="sub-para enterprise_p_tag"style={{color:'#000000'}}>For large teams with {'>'} 200 users</b>
                                          </div>
                                          <div className="pricing-table__body">
                                            <div className="pricing-table__footer pricing-table__footer-one">
                                              <Link href="/contact-us"
                                              className="ht-btn ht-btn-md">Contact Us
                                              </Link>
                                            </div>
                                            <div className="align-left mt-30">
                                              <b style={{color:'#000000'}}>Everything in Premium, plus</b>
                                              <ul className="dark-check-list">
                                                <li className="list-item">Multi-Site</li>
                                ...
                                <div className="row pricing-table-one">
                                  ...
                                  <div className="col-12 col-md-6 col-lg-3 col-xl-3 pricing-table" style={{ visibility: 'visible' }}>
                                    <div className="pricing-table__inner free-bg">
                                      ...
                                      <div className="pricing-table__header">
                                           ...
                                           <p  style={{color:'#000000', fontSize:'14px'}}  className='sub-para mt-2'> <b>For getting familiar with ELN </b></p>
                                        {/* <b className="sub-para" style={{color:'#000000'}}>For getting familiar with ELN</b><br></br> */}
                                        ...
                                        $<span id="price_lite2">{isNaN(calculatedPrices.roundliteAnnual)? 108 : Math.round(calculatedPrices.roundliteAnnual)}</span>
                                        </span>{' '}
                                        <span>for <span id="output1">{qty || 1}</span> user / year</span>
                                      </div>
                                      <div className="pricing-table__body">
                                        <div className="pricing-table__footer">
                                        ...
                                        <div className="align-left mt-30">
                                          <b>Everything you need, at no cost</b>
                                          <ul className="dark-check-list">
                                            <li className="list-item">Simple & User-friendly Interface</li>
                                            <li className="list-item">Invite up to 3 users</li>
                                            <li className="list-item">SSO (Google and Microsoft)</li>
                                            <li className="list-item">Intuitive Experiment Templates</li>
                                            <li className="list-item">Basic Inventory </li>
                                          </ul>
                                        </div>
                                      </div>
                                  ...
                                  <div className="col-12 col-md-6 col-lg-3 col-xl-3 pricing-table" style={{ visibility: 'visible' }}>
                                    <div className="pricing-table__inner perpul-bg">
                                      ...
                                      <div className="pricing-table__header">
                                        ...
                                        <br />
                                        <span style={{color:'#000000'}}>per user / month</span>
                                        <br />
                                        <span className="total-price">
                                          $<span id="price_standard2">{isNaN(calculatedPrices.roundstandardAnnual) ? 216 : Math.round(calculatedPrices.roundstandardAnnual)}</span>
                                          {/* $<span id="price_standard2">{isNaN(calculatedPrices.roundliteAnnual)? 216 : Math.round(calculatedPrices.roundliteAnnual)}</span> */}
                                        </span>{' '}
                                        <span>for <span id="output2">{qty || 1}</span> user / year</span>
                                      </div>
                                      <div className="pricing-table__body">
                                        <div className="pricing-table__footer">
                                  ...
                                  <div className="col-12 col-md-6 col-lg-3 col-xl-3 pricing-table pricing-table--popular" style={{ visibility: 'visible' }}>
                                    <div className="pricing-table__inner green-bg">
                                      ...
                                      <div className="pricing-table__header">
                                        <h6 className="sub-title">Premium</h6>
                                        <b className="sub-para" style={{color:'#000000'}}>For mid-sized and large teams</b>
                                        <br />
                                        <span className="price">
                                        ...
                                        <br />
                                        <span className="total-price">
                                          {/* $<span id="price_premium2">{isNaN(calculatedPrices.roundpremiumAnnual) ? 324.00 : calculatedPrices.roundpremiumAnnual.toFixed(2)}</span> */}
                                          
                                          $<span id="price_premium2">{isNaN(calculatedPrices.roundliteAnnual) ? 324 : Math.round(calculatedPrices.roundpremiumAnnual)}</span>
                                        </span>{' '}
                                        <span>for <span id="output3">{qty}</span> user / year</span>
                                      </div>
                                      <div className="pricing-table__body">
                                        <div className="pricing-table__footer">
                                          <a href="https://logilabelnlite.azurewebsites.net/register" target="_blank" className="ht-btn ht-btn-md">
                                  ...
                                  <div className="col-12 col-md-6 col-lg-3 col-xl-3 pricing-table" style={{ visibility: 'visible' }}>
                                    <div className="pricing-table__inner blue-bg" >
                                      ...
                                      <div className="pricing-table__header">
                                        <h6 className="sub-title">Enterprise</h6>
                                        <b className="sub-para enterprise_p_tag" style={{padding:"15px", color:'#000000'}}>For large teams with &gt; 200 users</b>
                                      </div>
                                      <div className="pricing-table__body">
                                        <div className="pricing-table__footer pricing-table__footer-one">
                        ...
                        {activeTabinner === 'academic-tab' && <div className={`tab-pane ${activeTabinner === 'academic-tab' ? "active show" : ""} `} id="academic-tab" role="tabpanel">
      <div className="toggle-container">
        <div className="pricing-options">
              ...
              <div className="col-12 col-md-6 col-lg-4 col-xl-4 pricing-table">
                <div className="pricing-table__inner free-bg">
                  ...
                  <p  style={{color:'#000000', fontSize:'14px'}}  className='sub-para mt-2'> <b>For getting familiar with ELN </b></p>
                    ...
                    <span>per user / month</span><br />
                    <span className="total-price">$<span id="price_lite2_a">{isNaN(calculatedPrices.roundyearlyLite) ? 76 : calculatedPrices.roundyearlyLite.toFixed(2)}</span></span> <span>for <span id="output4">{qty || 1}</span> </span>
                  </div>
                  <div className="pricing-table__body">
                    <div className="pricing-table__footer">
                      <Link href="https://logilabelnlite.azurewebsites.net/register" className="ht-btn ht-btn-md">Try for free</Link>
              ...
              <div className="col-12 col-md-6 col-lg-4 col-xl-4 pricing-table">
                <div className="pricing-table__inner perpul-bg">
                  ...
                  <div className="pricing-table__header">
                    ...
                    <span>per user / month</span><br />
                    <span className="total-price">$<span id="price_standard2_a">{isNaN(calculatedPrices.roundyearlyStandard) ? 151 : calculatedPrices.roundyearlyStandard.toFixed(2)}</span></span> <span>for <span id="output5">{qty || 1}</span> users</span>
                  </div>
                  <div className="pricing-table__body">
                    <div className="pricing-table__footer">
                      <Link href="https://logilabelnlite.azurewebsites.net/register" target="_blank" className="ht-btn ht-btn-md">Get started</Link>
              ...
              <div className="col-12 col-md-6 col-lg-4 col-xl-4 pricing-table pricing-table--popular">
                <div className="pricing-table__inner green-bg">
                  ...
                  <div className="pricing-table__header">
                    ...
                    <span>per user / month</span><br />
                    <span className="total-price">$<span id="price_premium2_a">{isNaN(calculatedPrices.roundyearlyPremium) ? 227.00 : calculatedPrices.roundyearlyPremium.toFixed(2)}</span></span> <span>for <span id="output6">{qty || 1}</span> users</span>
                  </div>
                  <div className="pricing-table__body">
                    <div className="pricing-table__footer">
                      <Link href="https://logilabelnlite.azurewebsites.net/register" target="_blank" className="ht-btn ht-btn-md">Get started</Link>
...
{/*     
      <div className="service-projects-wrapper section-space--ptb_100">
        <div className="container">
                  ...
                  <div className="col-lg-4 bg-gray1 lsec">
                    <center>
                      ...
                      <div className="hero-button mt-40 mb-40">
                          <Link href="https://logilabelnlite.azurewebsites.net/register" className="btn btn--blue" style={{ padding: '0 18px', lineHeight: '35px', height: '34px' }}>
                            start for free
                        </Link>
                      </div>
                    </center>
                ...
                <div className="row" style={{ margin: '5px' }}>
                  <div className="col-lg-4 bg-gray1 lsec">
                    <center>
                      ...
                      <br></br>
                      <div className="hero-button mt-40 mb-40">
                        <Link href="/" className="btn btn--blue" style={{ padding: '0 18px', lineHeight: '35px', height: '34px' }}>
                            Get a Full Story
                          </Link>
                      </div>
                    </center>
         ...
         <div className="litehead bg-lblue py-5 litte-pt-pb">
            <div className="container">
            <div className="mt-2">
            <div className="hosting_title sec_title erp_title text-center">
      
            <h2 className="fw-bold text-center compare-sub ">
                  Logilab ELN helps you and your team work  <span style={{color:'#1163ea'}} className= "mx-2">  Sm<Image src={smart_blub} className="img-fluid smart-blub" alt=""/>rter</span> 
            ...
            <div className=" container compare-bg-gradiant mt-5 py-4 compare-cta">
               <div className="row">
                    <div className="col-lg-8 d-flex flex-column justify-content-center align-items-center py-2">
                      <h4 className="text-white f_700 text-center compare-Kickstart py-2" style={{maxWidth:'612px',lineHeight:'1.4'}}>Kick-start Your Research & Elevate Your Lab Record-Keeping with Logilab ELN for Free </h4>
      ...
      <div className="dashboard-slider-wrapper bg-lblue section-space--pt_100 text-center section-space--pb_40">
        <div className="container">
                    ...
                    <div className="tab-lims-wrap section-space--mt_60">
                      <div className="row">
                        <div className="col-lg-7">
                          <h3 className='cloudSaaS-display-none'>Cloud-SaaS</h3>
                          <p>
                ...
                {activeTab === 'dedicated' ? (
                  <div className="tab-pane fade show active">
                    <div className="tab-history-wrap section-space--mt_60">
                      <div className="row">
                        <div className="col-lg-7">
                          <h3 className='cloudSaaS-display-none'>Dedicated Hosting</h3>
                          <p>
          ...
          <div className="row tab-hide-mobile CloudSaaS-tab-hide-mobile section-space--ptb_80">
      ...
      {activeTab === 'saas' ? (
        <div className="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" style={{padding:"0"}}>
          <div className="row">
            <div className="col-lg-7 align-left">
              {/* Section title */}
              <p className="heading Cloud-SaaS-heading">Cloud - SaaS</p>
              <p>
        ...
        <div className="tab-pane fade show active" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab" style={{padding:"0"}}>
          <div className="row">
            <div className="col-lg-7 align-left">
              {/* Section title */}
              <p className="heading Cloud-SaaS-heading">Dedicated Hosting</p>
              <p>
  ...
  <div id="plan-table" className="feature-images-wrapper section-space--pt_60 section-space--pb_30">
    ...
    <thead>
	 <tr>
        ...
        <tr>
            <th></th>
            <th className="lred-header plan-header">For First-Time Users</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td className="lred-header check" data-label="Free">✓</td>
        ...
        <tr>
            <td className="support feature" data-label="Feature">Dynamic Reports</td>
            <td className="cross lred-header" data-label="Free">—</td>
            <td className="cross" data-label="Standard" style={{backgroundColor:'#fff'}}>—</td>
            <td className="lgreen-header" data-label="Premium"><span style={{color:'green', fontWeight:'bold'}}> ✓</span> <span style={{display:"block", color:"#273b5e",fontWeight:"normal"}}></span></td>
            <td className="" data-label="Enterprise"><span style={{color:'green', fontWeight:'bold'}}> ✓</span> <span style={{display:"block", color:"#273b5e",fontWeight:"normal"}}></span></td>
        </tr>
        <tr>
        ...
        {isExpanded && (<><tr>
                  ...
                  <tr>
                    ...
                    <tr>
                    <td className="support feature" data-label="Feature">IQ/OQ Validations </td>
                    <td className="lred-header" data-label="Free">N/A</td>
                    <td data-label="Standard">Installation and operational qualification</td>
                    <td className="lgreen-header" data-label="Premium">Installation and operational qualification</td>
                    <td data-label="Enterprise">Installation and operational qualification</td>
                  </tr>
                    </>)}
        <tr className="feature-header">
        ...
        {isExpandedlist && (<><tr>
            <td className="storage text-left feature" data-label="Feature">Storage</td>
        ...
        <tr>
            <td className="support feature" data-label="Feature">Support</td>
        ...
        {isExpandedvist && (<><tr>
            <td className="storage feature" data-label="Feature">Chemical Drawings</td>
            <td className="lred-header"data-label="Free">N/A</td>
            <td data-label="Standard">Kekule.js</td>
            <td className="lgreen-header" data-label="Premium">Marvin.js with Chem Draw Support<span style={{display:"block", color:"#273b5e",fontWeight:"normal"}}>(Optional Paid Add-on)</span></td>
            <td data-label="Enterprise">Marvin.js with Chem Draw Support<span style={{display:"block", color:"#273b5e",fontWeight:"normal"}}>(Optional Paid Add-on)</span></td>
        </tr>
    
        <tr>
            <td className="support feature" data-label="Feature">Instrument Integration via Parser</td>
            <td className="cross lred-header" data-label="Free">—</td>
            <td className=" cross" data-label="Standard" style={{backgroundColor:'#fff'}}>—</td>
            <td className="lgreen-header" data-label="Premium"> <span style={{color:'green', fontWeight:'bold'}}> ✓</span> <span style={{display:"block", color:"#273b5e",fontWeight:"normal"}}>(Optional Paid Add-on)</span></td>
            <td className="" data-label="Enterprise"><span style={{color:'green', fontWeight:'bold'}}> ✓</span> <span style={{display:"block", color:"#273b5e",fontWeight:"normal"}}>(Optional Paid Add-on)</span></td>
        </tr>
        </>)}
    </tbody>
</table>
                  ...
                  <a className="ht-box-images style-02">
                    <div className="image-box-wrap icon-box">
                      <div className="content plan-content">
                        <h6 className="box-heading box-heading-plan">
                      ...
                      <div className="box-image plan-content-image">
                        {/* <img className="img-fluid image-icon" src="/assets/images/eln/box1.svg" alt="Box 1" /> */}
                        <Image src={box1} className="img-fluid image-icon" alt="" />
    ...
    {/* <div className="feature-images-wrapper bg-lblue section-space--ptb_100 planpage-bg-dblue">
      <div className="container">
