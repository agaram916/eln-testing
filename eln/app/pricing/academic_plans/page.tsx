...
import loglab_Eln_new_accadmic from '../../../public/assets/images/loglab_Eln_new_accadmic.svg'
  ...
  <div className="pricing-table-area section-space--ptb_100 bg-gray1">
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="responsive-tabs-academic-button">
                          {/* <span className="dropdown-arrow" onClick={handleTabClick}></span> 
                            <ul className="nav nav-tabs justify-content-center ht-tab-menu" role="tablist" style={{borderBottom:"0"}}>
                                ...
                                <li className="tab__item nav-item">
                                    <a className="nav-link" id="nav-tab2"   aria-selected="false" style={{backgroundColor:"#1163ea", color:'#fff'}}>Academic plans</a>
                                </li>
                            </ul>
                        </div>
                        </div> */}
                    ...
                    <div className="tab-content ht-tab__content wow move-up ">
                        ...
                        <div className="tab-pane active responsive-tabs-togglecontainer" id="academic-tab" role="tabpanel">
      {/* <div className="toggle-container">
        <div className="pricing-options">
      ...
      <div className="pricing-details academic-price">
      <div id="monthlyPricing2" className={`pricing-plan ${isMonthly ? 'active' : ''}`}>
        {/* Monthly pricing details */}
        <div className="pricing-table-content-area">
          <div className="container">
            <div className="row pricing-table-one">
              <div className="col-12 col-md-12 col-lg-12 col-xl-12 pricing-table">
                <div className="pricing-table__inner ">
                  <div className='div-bg free-bg'>
                    <div className="pricing-table__header">
                      <Image src={loglab_Eln_new_accadmic} className="img-fluid mb-2 " alt=""/> 
                      <p style={{fontSize:'24px', color:'#000000', lineHeight:'1.34'}} className='mt-2 mb-0'> For students, <b>PhD scholars
                      <br/>& academic researchers </b></p>
                      <span style={{fontSize:'12px'}}>Everything needed for effortless research</span>
                    ...
                    <div className="pricing-table__body">
                      ...
                      <div className="align-left mt-30 bg-grid">
                        <ul className="dark-check-list">
                          <li className="list-item signlesite">Single Site</li>
                          <li className="list-item inviteup">Invite up to 3 users</li>
                          <li className="list-item sso">SSO (Google and Microsoft)</li>
                          <li className="list-item intuitive">Intuitive Experiment Templates</li>
                          <li className="list-item basicinventory">Basic Inventory</li>
                          <li className="list-item config">Configurable Workflows</li>
                        </ul>
                      </div>
                    </div>
                  </div>
              ...
              {/* <div className="col-12 col-md-6 col-lg-4 col-xl-4 pricing-table">
                <div className="pricing-table__inner perpul-bg">
                  ...
                  <div className="pricing-table__header">
                    <h6 className="sub-title">Standard</h6>
                    <b className="sub-para" style={{color:'#000000'}}>Everything in Lite Plan plus:</b><br />
                  ...
                  <div className="pricing-table__body">
                    ...
                    <div className="align-left mt-30">
                      <b style={{color:'#000000'}}>Everything in Lite, plus</b>
                      <ul className="dark-check-list">
                        <li className="list-item">Single Site</li>
                        <li className="list-item">Basic Inventory</li>
                        <li className="list-item">Configurable Workflows</li>
              ...
              {/* <div className="col-12 col-md-6 col-lg-4 col-xl-4 pricing-table pricing-table--popular">
                <div className="pricing-table__inner green-bg">
                  ...
                  <div className="pricing-table__header">
                    <h6 className="sub-title">Premium</h6>
                    <b className="sub-para" style={{color:'#000000'}}>Perfect for mid-sized and large teams</b><br />
            ...
            <div className="row pricing-table-one">
              <div className="col-12 col-md-6 col-lg-4 col-xl-4 pricing-table">
                <div className="pricing-table__inner free-bg">
                  ...
                  <div className="pricing-table__header">
                      <Image src={loglab_Eln_new_accadmic} className="img-fluid mb-2 " alt=""/>
                    <p style={{fontSize:'14px', color:'#000000'}} className='mt-2'> <b>For students, PhD scholars & academic <br/>researchers </b></p>
                    {/* <span className="price">$<span id="singleuser_lite2_a">{calculatedPrices.yearlyLite}</span></span><br />
                    <span style={{color:'#000000'}}>per user / month</span><br />
                    <span className="total-price" style={{color:'#000000'}}>$<span id="price_lite2_a">{isNaN(calculatedPrices.roundyearlyLite) ? 76 :Math.round (calculatedPrices.roundyearlyLite)}</span></span> <span>for <span id="output4">{qty || 1}</span> user / year</span>      */}
                  </div>
                  <div className="pricing-table__body">
                    <div className="pricing-table__footer">
                      <Link href="https://logilabelnlite.azurewebsites.net/register" className="ht-btn ht-btn-md">Get started</Link>
                    ...
                    <div className="align-left mt-30">
                      <b>Everything you need to streamline you research </b>
                      <ul className="dark-check-list">
                        <li className="list-item">Single Site</li>
              ...
              <div className="col-12 col-md-6 col-lg-4 col-xl-4 pricing-table">
                <div className="pricing-table__inner perpul-bg">
                  ...
                  <div className="pricing-table__header">
                    ...
                    <span style={{color:'#000000'}}>per user / month</span><br />
                    <span className="total-price" style={{color:'#000000'}}>$<span id="price_standard2_a">{isNaN(calculatedPrices.roundyearlyStandard) ? 151 : Math.round(calculatedPrices.roundyearlyStandard)}</span></span> <span>for <span id="output5">{qty || 1}</span> user / year</span> */}
                  </div>
                  <div className="pricing-table__body">
                    <div className="pricing-table__footer">
                      <Link href="https://logilabelnlite.azurewebsites.net/register" target="_blank" className="ht-btn ht-btn-md">Get started</Link>
              ...
              <div className="col-12 col-md-6 col-lg-4 col-xl-4 pricing-table pricing-table--popular">
                <div className="pricing-table__inner green-bg">
                  ...
                  <div className="pricing-table__header">
                    ...
                    <span>per user / month</span><br />
                    <span className="total-price">$<span id="price_premium2_a">{isNaN(calculatedPrices.roundyearlyPremium) ? 227 : Math.round (calculatedPrices.roundyearlyPremium)}</span></span> <span>for <span id="output6">{qty || 1}</span> user / year</span> */}
                  </div>
                  <div className="pricing-table__body">
                    <div className="pricing-table__footer">
                      <Link href="https://logilabelnlite.azurewebsites.net/register" target="_blank" className="ht-btn ht-btn-md">Get started</Link>
                  ...
                  <div className=" container compare-bg-gradiant mt-5 py-4 compare-cta">
                     <div className="row">
                          <div className="col-lg-8 d-flex flex-column justify-content-center align-items-center py-2">
                            <h4 className="text-white f_700 text-center compare-Kickstart py-2" style={{maxWidth:'612px',lineHeight:'1.4'}}>Kick-start Your Research & Elevate Your Lab Record-Keeping with Logilab ELN for Free (Yes, Free!)ite </h4>
          ...
          <div className="row section-space--mb_40 tab-hide-laptop section-space--mt_100">
            <div className="col-lg-12 ht-tab-wrap">
              <div className="row">
                ...
                <div className={`responsive-tabs mt-2 ${isOpen ? 'open' : ''}`} onClick={handleTabClick}>
                  <span className="dropdown-arrow" onClick={handleTabClick}></span>
