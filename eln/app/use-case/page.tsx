  ...
  smartSpeed: 200,
    ...
    return (
                                ...
                                <div className='container text-center '>
                                    <div className="text-center use-case-bg-heading-content">
                                        ...
                                        <p className=''>Simplified Lab Inventory  at Your Fingertips <Image src={sample6} className="img-fluid ms-2 Fingertips" alt="" /></p> 
                                          ...
                                          <Link href="/request-a-demo" className="btn btn--white mx-2">
                                            Request a Demo
                                          </Link>
                                          <Link href="/product-brochure-download" className="btn btn--white mx-2">
                                              Download Brochure
                                          </Link>
                                     </div>
                                </div>
            ...
            <div className='container use-case-section-space-pt_100'>
                <div className='text-center Real-Worl-section'>
                    ...
                    <h6 className='text-black'>Everything Literally</h6>
                     <p className='text-black'>Design Your Digital Lab Around Real-World Needs</p>
                </div>
                    <div className='row'>
            ...
            <div className='mt-5 use-mt-5'>
               <div className='container '>
                    <div className='text-center use-case-section-space--pt_100 use-case-section-heading'>
                         ...
                         <p>Oraganize, Track, & Manage Any Type of Inventory</p>
                    </div>       
             </div>
             ...
             <div className=''>
               <div className='container '>
                    <div className='text-center use-case-section-heading use-case-section-space--pt_100'>
                         <h5 className='smart-storage'>Equipment & Calibration</h5>
        ...
        <div className=''>
               <div className='container'>
                    <div className='text-center use-case-section-heading use-case-section-space--pt_100'>
                         <h5 className='smart-storage'>Labeling & Sample Identification</h5>
                         <h1 className='text-black'> Smart & Efficient </h1>
             ...
             <div className='container'>
                  <div className='use-case-cta-section'>
                      <p className='text-black ps-4'>Take the hassle out of <span style={{ backgroundColor:'#F3D278', fontWeight:'bold'}} className='px-2 py-2'>Inventory Management</span></p>
                      <h2 className='text-black ps-4 '>Track, Manage, and Access  your Inventory<br></br><span style={{ fontWeight:'300'}}> -without the stress </span> </h2>
                      <div className='text-end mb-3'>
                      <a className='btn use-case-cta-button'>Try Now</a>
                    </div>
                 </div>
             </div>
             </div>
