...
import Publicwhite from '../../../public/assets/images/publication/dairy.svg';
...
import Cord_Blood_Casestudy from '../../../public/assets/images/publication/Cord_Blood_Casestudy.svg';
...
import poster from '../../../public/assets/images/publication/Frame 90.svg'
            ...
            <div className='publication-home'>
                ...
                <div className='container'> 
                    ...
                    <div className='row mx-2  pb-5'>
                     ...
                     <div className='col-lg-6 col-md-6 mt-5'>
                      <div className="card publication-white-cards">
                        <Image  alt='' src={Megafine_Casestudy} className="w-100 img-fluid"  />                              
                             <div className="card-body px-4 py-2">
                             <a className='publication-category'>Case Study</a>
                               <h5 className="card-title mt-2">How Logilab ELN Enables Pharma Labs to Achieve 21 CFR Part 11 & FDA Compliance</h5>
                                <p className="card-text mt-2">A pharmaceutical company involved in manufacturing active pharmaceutical ingredients (APIs), advanced intermediates, etc., faced significant challenges in complying with regulatory compliance requirements, particularly...</p>
                                <Link className='er_btn er_btn_two' href='/casestudy-download'>Download</Link>
                            </div>
                    </div>
                     </div>
                     ...
                     <div className='col-lg-6 col-md-6 mt-5'>
                     <div className="card publication-white-cards">
                        <Image  alt='' src={Cord_Blood_Casestudy} className="w-100 img-fluid"  />                               
                             <div className="card-body px-4 py-2">
                             <a className='publication-category'>Case Study</a>
