  ...
  <div className="lite-page compare">
            ...
            <div className="header__actions--preview">
                ...
                <div className="col-lg-12  pt-4 litebannercol">
                    <div className="solution_security_banner_content lite bannerresolution">
                      ...
                      Logilab Eln – Everything you need, <br/> without  breaking the bank
                      </h1>
    ...
    <div className="container">
       ...
       <div className="hosting_title sec_title erp_title text-center">
        <h2 className="text-center pt-2 fw-bold ">What Sets Logilab ELN Apart?</h2>
       </div> 
         ...
         <div className="col-lg-6 desktoplite">  
            <div className="ms-5 ps-5 responsive-margin-padding one_section_para one_section_bg_para">
                <p className="text-black what-para">Logilab ELN simplifies research data management,streamlines inventory tracking, 
...
<div className="litespan">
                  <li className="list-item">
                  <span style={{ fontWeight: 'bold' }}>Start Small, Scale Big:&nbsp;</span> Begin with our affordable  plan, ideal for individual users or smaller teams, and easily upgrade as your lab or team grows.
										</li>
                    </div>
                    <div className="litespan">
										<li className="list-item">
      ...
      <div className="container">
        <Accordion defaultActiveKey="0">
          <Accordion.Item eventKey="0">
            <Accordion.Header>
            How can I get started with Logilab ELN ? 
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="1">
            ...
            <Accordion.Body>
            Logilab ELN makes transitioning from paper-based systems, Excel, or MS Word seamless. It allows users to import existing documents, minimizing disruptions and enabling labs to quickly adapt to the digital platform while continuing their work.
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="2">
            ...
            <Accordion.Body>
            Logilab ELN  follows industry-standard security protocols to protect your data. It includes role-based access control, encrypted storage, and secure cloud backups, ensuring that lab data is safe and accessible only to authorized users. 
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="3">
            ...
            <Accordion.Body>
            As your lab’s needs grow, you can easily upgrade from Logilab ELN  to the standard/premium version. The upgrade unlocks advanced features like regulatory compliance, audit trail, multistep workflows, and enhanced inventory management. All data, settings, and workflows transfer seamlessly without retraining.
            </Accordion.Body>
          </Accordion.Item>          
        </Accordion>  
                            ...
                            <div className=" text-center logpositionchange">
                                ...
                                <div className="d-flex justify-content-center align-items-center mt-4">
                                    <div className="action_btn job-button text-md">
                                      <Link href="/request-a-demo" className="btn btn--blue">Request Demo</Link>
                                    </div>
                                    <div className="action_btn job-button text-md Registorheader">
                                      <Link href="/features-brochure-download" className="btn btn--blue ms-4">Download Brochure</Link>
                                    </div>
                                  </div>
                                </div>
                          </div>
